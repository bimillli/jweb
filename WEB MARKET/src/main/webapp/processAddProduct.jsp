...
<%
	...
	//파일의경로
	String realFolder = "C:/Dev/jspworks/WEB MARKET/src/main/webapp/upload";
	int maxSize = 5*1024*1024;  //최대용량5MB
	...
	//String filenameunitsInStock = request.getParameter("filename");
	...
	String productImage = multi.getFilesystemName(fname); //이미지파일
